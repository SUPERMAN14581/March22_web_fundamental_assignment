...
function displayData(recipeList){
    ...
    for (let i = 0; i < recipeList.length; i++) {
        ...
        <img class="img" src="https://natashaskitchen.com/wp-content/uploads/2021/08/Grilled-Cheese-Sandwich-SQ.jpg"/>
                <div class="flex-items">
                <p>${element.recipe.source}</p>  
                </div>
                <div>
                <button><a href=${element.recipe.url}>View Recipe</a></button>
                </div>
